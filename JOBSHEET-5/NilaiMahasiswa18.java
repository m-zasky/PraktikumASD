// algoritma untuk mencari nilai tertinggi, terendah, dan rata-rata

public class NilaiMahasiswa18 {

    // a. Mencari Nilai UTS Tertinggi (Divide and Conquer)
    public int utsTertinggi(Mahasiswa18[] mhs, int l, int r) {
        if (l == r) { // Base Case
    ...
    public int utsTerendah(Mahasiswa18[] mhs, int l, int r) {
        if (l == r) { // Base Case
            return mhs[l].nilaiUTS;
        } else {
            int mid = (l + r) / 2;
    ...
    public double rataUAS(Mahasiswa18[] mhs) {
        double total = 0;
